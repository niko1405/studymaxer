import { ArrowLeft, ArrowRight, Bookmark, BookmarkCheck, Brain, CheckCircle2, CheckSquare, Clock, Star } from "lucide-react";
import { getDayInLife, getRecommendations, getTasks, matches, quizQuestions } from "../../config/mock";
...
function MatchesDetailView() {
  ...
  const recommendations = getRecommendations(match.type, match.id);
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white pb-[100px] relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 px-6 py-4 transition-all duration-300 bg-linear-to-b from-[#020617]/90 to-transparent">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2.5 rounded-full border backdrop-blur-md transition-all duration-300 shadow-lg ${
              isSaved 
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            {recommendations.map((item, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className={`group bg-white/5 border border-white/5 rounded-3xl p-5 hover:border-blue-500/30 hover:bg-white/10 transition-all cursor-pointer relative overflow-hidden ${getFadeUpClass()}`}
        ...
        {/* --- REAL-WORLD TASKS (New Section) --- */}
        <div className={`mb-20 ${getFadeUpClass()}`} style={{ transitionDelay: '300ms' }}>
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className={`w-6 h-6 rounded-full border flex items-center justify-center transition-colors ${
                    completedTasks.includes(task.title) ? 'bg-blue-500 border-blue-500' : 'border-slate-600'
                  }`}>
        ...
        {/* --- DAY IN THE LIFE --- */}
        <div className={`mb-24 ${getFadeUpClass()}`} style={{ transitionDelay: '400ms' }}>
        ...
        {/* --- BOTTOM CTA --- */}
        <div className={`relative rounded-[2.5rem] overflow-hidden ${getScaleInClass()}`} style={{ transitionDelay: '500ms' }}>
